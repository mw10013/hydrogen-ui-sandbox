...
export type ProductQuery = { __typename?: 'QueryRoot', product?: { __typename?: 'Product', handle: string, title: string, description: string, options: Array<{ __typename?: 'ProductOption', name: string, values: Array<string> }>, variants: { __typename?: 'ProductVariantConnection', nodes: Array<{ __typename?: 'ProductVariant', id: string, priceV2: { __typename?: 'MoneyV2', amount: string }, selectedOptions: Array<{ __typename?: 'SelectedOption', name: string, value: string }> }> } } | null };
